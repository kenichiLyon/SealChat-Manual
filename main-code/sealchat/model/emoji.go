...
func UserEmojiCreate(userId string, attachmentId string, remark string) (*UserEmojiModel, error) {
	item := &UserEmojiModel{
...
func GetUserEmoji(id string) (*UserEmojiModel, error) {
	var item UserEmojiModel
...
func UpdateUserEmoji(item *UserEmojiModel, fields map[string]interface{}) error {
	return db.Model(item).Updates(fields).Error
}
